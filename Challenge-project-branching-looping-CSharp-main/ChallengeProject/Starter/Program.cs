    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    // check if age and physical description are missing
                    if (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?")
                    {
                        editAge = true;
                        Console.WriteLine($"Animal with {ourAnimals[i, 0]} is missing age information.");
                        while (editAge == true)
                        {
                            ...
                            if (readResult != null)
                            {
                                validAge = int.TryParse(readResult, out currentAnimalAge);
                                if (validAge == true)
                                {
                                    editAge = false;
                                    animalAge = currentAnimalAge.ToString();
                                    
                                    // Console.WriteLine($"Now {ourAnimals[i,0]} has {ourAnimals[i, 2]}");
                                }
                            }
                        }
                    }
                    ...
                    {
                        editPhysicalDesc = true;
                        Console.WriteLine($"Animal with {ourAnimals[i, 0]} is missing physical description.");
                        while (editPhysicalDesc == true)
                        {
                            ...
                            if (readResult != null)
                            {
                                ...
                                if (animalPhysicalDescription.Length > 5)
                                {
                                    editPhysicalDesc = false;
                                    // Console.WriteLine($"Now {ourAnimals[i,0]} has {ourAnimals[i,4]}");
                                }
                            }
                        }
                    }
            ...
            if (editAge == false && editPhysicalDesc == false)
            {
        ...
        case "4":
            ...
            bool editPersonality = false;

            // nickname is on entry 3, personality is on entry 5
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        editPersonality = true;
                        while (editPersonality == true)
                        {
            ...
            if (editNickname == false && editPersonality == false)
            {
