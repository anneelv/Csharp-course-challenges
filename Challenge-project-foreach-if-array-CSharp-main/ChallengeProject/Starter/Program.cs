    ...
    */
    foreach (int score in studentScores)
    {
        ...
        else
        {
            ...
            sumExtraCreditPoints += score / 10;
        }
    }

    currentStudentExamScore = (decimal)(sumExamScores) / examAssignments;
    currentStudentExtraCredit = (sumExtraCreditScores) / gradedExtraCredit;

    currentStudentOverallGrade = ((decimal)(sumExamScores) + (decimal)(sumExtraCreditScores) / 10) / examAssignments;

    currentStudentExtraCreditPoints = ((decimal)(sumExtraCreditScores) / 10) / examAssignments;
